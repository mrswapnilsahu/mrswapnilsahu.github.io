  ...
  return (
    <div className="md:hidden flex flex-col items-center text-center mt-0 w-full max-w-full overflow-hidden px-4 pb-8">
      ...
      <div className="w-full space-y-4 max-w-sm">
        <NeoButton
          className="w-full justify-center bg-[#c996cc]"
          onClick={() => scrollTo("#experience")}
        >
          Work Experience
        </NeoButton>
        <NeoButton
          className="w-full justify-center bg-[#4ECDC4]"
        ...
        <NeoButton
          className="w-full justify-center bg-[#FF6B6B]"
...
const Hero: React.FC = () => {
  return (
    <header id="home" className="mb-12 relative px-4 md:px-0 container mx-auto">
      {/* Desktop Layout */}
      <div className="hidden md:block bg-neo-yellow border-4 border-black dark:border-white p-6 md:p-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] dark:md:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] relative z-10 text-black">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black leading-[0.9] tracking-tighter mb-8 uppercase break-words">
              ...
              <span className="text-white relative inline-block">
                ...
                <svg
                  className="absolute -bottom-2 md:-bottom-4 left-0 w-full z-20"
                  viewBox="0 0 300 15"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="M3 11C68.3033 4.22856 186.276 -4.84666 297 11"
                    stroke="black"
                    strokeWidth="4"
